...
export class VicControlRegisters {
    ...
    CharacterSize: number = 0; // if set to 1 then 8x16 characters. If set to 0, then 8x8 characters.
    ...
    Write(register: ControlRegisterEnum, value: number) {
        ...
        switch (register) {
            ...
            case ControlRegisterEnum.CR3_NO_OF_VIDEO_MATRIX_ROWS:
                ...
                this.CharacterSize = Utils.ExtractBits(this.ControlRegisters[ControlRegisterEnum.CR3_NO_OF_VIDEO_MATRIX_ROWS], 0, 0);
