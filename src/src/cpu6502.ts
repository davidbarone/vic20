...
class cpu6502 {
  ...
  private opcodes6502Documented: { [key: number]: OpCodeGenRule } = {
    ...
    //0xE4: "CPX zpg",
    //0xE5: "SBC zpg",
    0xE6: new OpCodeGenRule({ instruction: "INC", addressMode: "zpg", operation: "OPERAND = (OPERAND + 1) & 0xFF;", affectNFlag: true, affectZFlag: true }),
    ...
    //0xEC: "CPX abs",
    //0xED: "SBC abs",
    0xEE: new OpCodeGenRule({ instruction: "INC", addressMode: "abs", operation: "OPERAND = (OPERAND + 1) & 0xFF;", affectNFlag: true, affectZFlag: true }),
    //0xF0: "BEQ rel",
    //0xF1: "SBC ind,Y",
    //0xF5: "SBC zpg,X",
    0xF6: new OpCodeGenRule({ instruction: "INC", addressMode: "zpg,X", operation: "OPERAND = (OPERAND + 1) & 0xFF;", affectNFlag: true, affectZFlag: true }),
    //0xF8: "SED impl",
    //0xF9: "SBC abs,Y",
    //0xFD: "SBC abs,X",
    0xFE: new OpCodeGenRule({ instruction: "INC", addressMode: "abs,X", operation: "OPERAND = (OPERAND + 1) & 0xFF;", affectNFlag: true, affectZFlag: true }),
  };
