...
export default class cpu6502 {
  ...
  private opCodes6502Documented: { [key: number]: OpCodeGenRule } = {
    ...
    0x01: new OpCodeGenRule({ instruction: "ORA", addressMode: "X,ind", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x05: new OpCodeGenRule({ instruction: "ORA", addressMode: "zpg", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x06: new OpCodeGenRule({ instruction: "ASL", addressMode: "zpg", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, false));", write: true }),
    0x08: new OpCodeGenRule({ instruction: "PHP", addressMode: "impl", operation: "cpu.push(this.Registers.P.value);" }),
    0x09: new OpCodeGenRule({ instruction: "ORA", addressMode: "#", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x0A: new OpCodeGenRule({ instruction: "ASL", addressMode: "A", operation: "cpu.Registers.A = cpu.setnz(rotate(cpu.Registers.A, false, false));" }),
    0x0D: new OpCodeGenRule({ instruction: "ORA", addressMode: "abs", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x0E: new OpCodeGenRule({ instruction: "ASL", addressMode: "abs", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, false));", write: true }),
    ...
    0x11: new OpCodeGenRule({ instruction: "ORA", addressMode: "ind,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x15: new OpCodeGenRule({ instruction: "ORA", addressMode: "zpg,X", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x16: new OpCodeGenRule({ instruction: "ASL", addressMode: "zpg,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, false));", write: true }),
    0x18: new OpCodeGenRule({ instruction: "CLC", addressMode: "impl", operation: "cpu.Registers.P.Clear(ProcessorStatusFlag.Carry);" }),
    0x19: new OpCodeGenRule({ instruction: "ORA", addressMode: "abs,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x1D: new OpCodeGenRule({ instruction: "ORA", addressMode: "abs,X", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A | OPERAND);" }),
    0x1E: new OpCodeGenRule({ instruction: "ASL", addressMode: "abs,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, false));", write: true }),
    //0x20: "JSR abs",
    0x21: new OpCodeGenRule({ instruction: "AND", addressMode: "X,ind", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    //0x24: "BIT zpg",
    0x25: new OpCodeGenRule({ instruction: "AND", addressMode: "zpg", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    0x26: new OpCodeGenRule({ instruction: "ROL", addressMode: "zpg", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, true));", write: true }),
    0x28: new OpCodeGenRule({ instruction: "PLP", addressMode: "impl", operation: "cpu.Registers.P.value = cpu.pop();" }),
    0x29: new OpCodeGenRule({ instruction: "AND", addressMode: "#", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    0x2A: new OpCodeGenRule({ instruction: "ROL", addressMode: "A", operation: "cpu.Registers.A = cpu.setnz(rotate(cpu.Registers.A, false, true));" }),
    //0x2C: "BIT abs",
    0x2D: new OpCodeGenRule({ instruction: "AND", addressMode: "abs", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    0x2E: new OpCodeGenRule({ instruction: "ROL", addressMode: "abs", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, true));", write: true }),
    ...
    0x31: new OpCodeGenRule({ instruction: "AND", addressMode: "ind,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    0x35: new OpCodeGenRule({ instruction: "AND", addressMode: "zpg,X", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    0x36: new OpCodeGenRule({ instruction: "ROL", addressMode: "zpg,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, true));", write: true }),
    0x38: new OpCodeGenRule({ instruction: "SEC", addressMode: "impl", operation: "cpu.Registers.P.Set(ProcessorStatusFlag.Carry);" }),
    0x39: new OpCodeGenRule({ instruction: "AND", addressMode: "abs,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    0x3D: new OpCodeGenRule({ instruction: "AND", addressMode: "abs,X", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A & OPERAND);" }),
    0x3E: new OpCodeGenRule({ instruction: "ROL", addressMode: "abs,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, false, true));", write: true }),
    //0x40: "RTI impl",
    0x41: new OpCodeGenRule({ instruction: "EOR", addressMode: "X,ind", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x45: new OpCodeGenRule({ instruction: "EOR", addressMode: "zpg", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x46: new OpCodeGenRule({ instruction: "LSR", addressMode: "zpg", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, false));", write: true }),
    0x48: new OpCodeGenRule({ instruction: "PHA", addressMode: "impl", operation: "cpu.push(this.Registers.A);" }),
    0x49: new OpCodeGenRule({ instruction: "EOR", addressMode: "#", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x4A: new OpCodeGenRule({ instruction: "LSR", addressMode: "A", operation: "cpu.Registers.A = cpu.setnz(rotate(cpu.Registers.A, true, false));" }),
    //0x4C: "JMP abs",
    0x4D: new OpCodeGenRule({ instruction: "EOR", addressMode: "abs", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x4E: new OpCodeGenRule({ instruction: "LSR", addressMode: "abs", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, false));", write: true }),
    ...
    0x51: new OpCodeGenRule({ instruction: "EOR", addressMode: "ind,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x55: new OpCodeGenRule({ instruction: "EOR", addressMode: "zpg,X", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x56: new OpCodeGenRule({ instruction: "LSR", addressMode: "zpg,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, false));", write: true }),
    0x58: new OpCodeGenRule({ instruction: "CLI", addressMode: "impl", operation: "cpu.Registers.P.Clear(ProcessorStatusFlag.Interrupt);" }),
    0x59: new OpCodeGenRule({ instruction: "EOR", addressMode: "abs,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x5D: new OpCodeGenRule({ instruction: "EOR", addressMode: "abs,X", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.A ^ OPERAND);" }),
    0x5E: new OpCodeGenRule({ instruction: "LSR", addressMode: "abs,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, false));", write: true }),
    //0x60: "RTS impl",
    0x61: new OpCodeGenRule({ instruction: "ADC", addressMode: "X,ind", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x65: new OpCodeGenRule({ instruction: "ADC", addressMode: "zpg", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x66: new OpCodeGenRule({ instruction: "ROR", addressMode: "zpg", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, true));", write: true }),
    0x68: new OpCodeGenRule({ instruction: "PLA", addressMode: "impl", operation: "cpu.Registers.A = cpu.setnz(cpu.pop());" }),
    0x69: new OpCodeGenRule({ instruction: "ADC", addressMode: "#", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x6A: new OpCodeGenRule({ instruction: "ROR", addressMode: "A", operation: "cpu.Registers.A = cpu.setnz(rotate(cpu.Registers.A, true, true));" }),
    //0x6C: "JMP ind",
    0x6D: new OpCodeGenRule({ instruction: "ADC", addressMode: "abs", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x6E: new OpCodeGenRule({ instruction: "ROR", addressMode: "abs", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, true));", write: true }),
    ...
    0x71: new OpCodeGenRule({ instruction: "ADC", addressMode: "ind,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x75: new OpCodeGenRule({ instruction: "ADC", addressMode: "zpg,X", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x76: new OpCodeGenRule({ instruction: "ROR", addressMode: "zpg,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, true));", write: true }),
    0x78: new OpCodeGenRule({ instruction: "SEI", addressMode: "impl", operation: "cpu.Registers.P.Set(ProcessorStatusFlag.Interrupt);" }),
    0x79: new OpCodeGenRule({ instruction: "ADC", addressMode: "abs,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x7D: new OpCodeGenRule({ instruction: "ADC", addressMode: "abs,X", operation: "cpu.Registers.A = cpu.setnz(cpu.adc(OPERAND));" }),
    0x7E: new OpCodeGenRule({ instruction: "ROR", addressMode: "abs,X", operation: "OPERAND = cpu.setnz(rotate(OPERAND, true, true));", write: true }),
    ...
    0x88: new OpCodeGenRule({ instruction: "DEY", addressMode: "impl", operation: "cpu.Registers.Y = cpu.setnz((cpu.Registers.Y - 1) & 0xFF);" }),
    0x8A: new OpCodeGenRule({ instruction: "TXA", addressMode: "impl", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.X);" }),
    ...
    0x98: new OpCodeGenRule({ instruction: "TYA", addressMode: "impl", operation: "cpu.Registers.A = cpu.setnz(cpu.Registers.Y);" }),
    ...
    0xA0: new OpCodeGenRule({ instruction: "LDY", addressMode: "#", operation: "cpu.Registers.Y = cpu.setnz(OPERAND);" }),
    0xA1: new OpCodeGenRule({ instruction: "LDA", addressMode: "X,ind", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xA2: new OpCodeGenRule({ instruction: "LDX", addressMode: "#", operation: "cpu.Registers.X = cpu.setnz(OPERAND);" }),
    0xA4: new OpCodeGenRule({ instruction: "LDY", addressMode: "zpg", operation: "cpu.Registers.Y = cpu.setnz(OPERAND);" }),
    0xA5: new OpCodeGenRule({ instruction: "LDA", addressMode: "zpg", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xA6: new OpCodeGenRule({ instruction: "LDX", addressMode: "zpg", operation: "cpu.Registers.X = cpu.setnz(OPERAND);" }),
    0xA8: new OpCodeGenRule({ instruction: "TAY", addressMode: "impl", operation: "cpu.Registers.Y = cpu.setnz(cpu.Registers.A);" }),
    0xA9: new OpCodeGenRule({ instruction: "LDA", addressMode: "#", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xAA: new OpCodeGenRule({ instruction: "TAX", addressMode: "impl", operation: "cpu.Registers.X = cpu.setnz(cpu.Registers.A);" }),
    0xAC: new OpCodeGenRule({ instruction: "LDY", addressMode: "abs", operation: "cpu.Registers.Y = cpu.setnz(OPERAND);" }),
    0xAD: new OpCodeGenRule({ instruction: "LDA", addressMode: "abs", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xAE: new OpCodeGenRule({ instruction: "LDX", addressMode: "abs", operation: "cpu.Registers.X = cpu.setnz(OPERAND);" }),
    ...
    0xB1: new OpCodeGenRule({ instruction: "LDA", addressMode: "ind,Y", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xB4: new OpCodeGenRule({ instruction: "LDY", addressMode: "zpg,X", operation: "cpu.Registers.Y = cpu.setnz(OPERAND);" }),
    0xB5: new OpCodeGenRule({ instruction: "LDA", addressMode: "zpg,X", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xB6: new OpCodeGenRule({ instruction: "LDX", addressMode: "zpg,Y", operation: "cpu.Registers.X = cpu.setnz(OPERAND);" }),
    0xB8: new OpCodeGenRule({ instruction: "CLV", addressMode: "impl", operation: "cpu.Registers.P.Clear(ProcessorStatusFlag.Overflow);" }),
    0xB9: new OpCodeGenRule({ instruction: "LDA", addressMode: "abs,Y", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xBA: new OpCodeGenRule({ instruction: "TSX", addressMode: "impl", operation: "cpu.Registers.X = cpu.setnz(cpu.Registers.SP);" }),
    0xBC: new OpCodeGenRule({ instruction: "LDY", addressMode: "abs,X", operation: "cpu.Registers.Y = cpu.setnz(OPERAND);" }),
    0xBD: new OpCodeGenRule({ instruction: "LDA", addressMode: "abs,X", operation: "cpu.Registers.A = cpu.setnz(OPERAND);" }),
    0xBE: new OpCodeGenRule({ instruction: "LDX", addressMode: "abs,Y", operation: "cpu.Registers.X = cpu.setnz(OPERAND);" }),
    ...
    0xC6: new OpCodeGenRule({ instruction: "DEC", addressMode: "zpg", operation: "OPERAND = cpu.setnz((OPERAND - 1) & 0xFF);", write: true }),
    0xC8: new OpCodeGenRule({ instruction: "INY", addressMode: "impl", operation: "cpu.Registers.Y = cpu.setnz((cpu.Registers.Y + 1) & 0xFF);" }),
    0xC9: new OpCodeGenRule({ instruction: "CMP", addressMode: "#", operation: "cpu.compare(cpu.Registers.A, OPERAND);" }),
    0xCA: new OpCodeGenRule({ instruction: "DEX", addressMode: "impl", operation: "cpu.Registers.X = cpu.setnz((cpu.Registers.X - 1) & 0xFF);" }),
    ...
    0xCE: new OpCodeGenRule({ instruction: "DEC", addressMode: "abs", operation: "OPERAND = cpu.setnz((OPERAND - 1) & 0xFF);", write: true }),
    ...
    0xD6: new OpCodeGenRule({ instruction: "DEC", addressMode: "zpg,X", operation: "OPERAND = cpu.setnz((OPERAND - 1) & 0xFF);", write: true }),
    ...
    0xDE: new OpCodeGenRule({ instruction: "DEC", addressMode: "abs,X", operation: "OPERAND = cpu.setnz((OPERAND - 1) & 0xFF);", write: true }),
    0xE0: new OpCodeGenRule({ instruction: "CPX", addressMode: "#", operation: "cpu.compare(cpu.Registers.X, OPERAND);" }),
    0xE1: new OpCodeGenRule({ instruction: "SBC", addressMode: "X,ind", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    0xE4: new OpCodeGenRule({ instruction: "CPX", addressMode: "zpg", operation: "cpu.compare(cpu.Registers.X, OPERAND);" }),
    0xE5: new OpCodeGenRule({ instruction: "SBC", addressMode: "zpg", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    0xE6: new OpCodeGenRule({ instruction: "INC", addressMode: "zpg", operation: "OPERAND = cpu.setnz((OPERAND + 1) & 0xFF);", write: true }),
    0xE8: new OpCodeGenRule({ instruction: "INX", addressMode: "impl", operation: "cpu.Registers.X = cpu.setnz((cpu.Registers.X + 1) & 0xFF);" }),
    0xE9: new OpCodeGenRule({ instruction: "SBC", addressMode: "#", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    ...
    0xED: new OpCodeGenRule({ instruction: "SBC", addressMode: "abs", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    0xEE: new OpCodeGenRule({ instruction: "INC", addressMode: "abs", operation: "OPERAND = cpu.setnz((OPERAND + 1) & 0xFF);", write: true }),
    ...
    0xF1: new OpCodeGenRule({ instruction: "SBC", addressMode: "ind,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    0xF5: new OpCodeGenRule({ instruction: "SBC", addressMode: "zpg,X", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    0xF6: new OpCodeGenRule({ instruction: "INC", addressMode: "zpg,X", operation: "OPERAND = cpu.setnz((OPERAND + 1) & 0xFF);", write: true }),
    0xF8: new OpCodeGenRule({ instruction: "SED", addressMode: "impl", operation: "cpu.Registers.P.Set(ProcessorStatusFlag.Decimal);" }),
    0xF9: new OpCodeGenRule({ instruction: "SBC", addressMode: "abs,Y", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    0xFD: new OpCodeGenRule({ instruction: "SBC", addressMode: "abs,X", operation: "cpu.Registers.A = cpu.setnz(cpu.sbc(OPERAND));" }),
    0xFE: new OpCodeGenRule({ instruction: "INC", addressMode: "abs,X", operation: "OPERAND = cpu.setnz((OPERAND + 1) & 0xFF);", write: true }),
  };
