...
## Background
Around 1981 (I think) - I would have been 11 at the time, for Christmas, I got given my first ever home computer, a Commodore Vic20. I still clearly remember that day, and unboxing and setting up the computer, and writing the first demo BASIC program that was in the user manual - an ASCII bird flying down the screen. I remember the fascination I had playing with this machine, and tinkering with the built-in BASIC interpreter. I remember pestering my mum for pocket money to buy the latest games, and I remember begging in particular for the 16K expansion cartridge (although a buying an expansion cartridge that didn't actually have any games on it probably felt fairly pointless to her!).

At the age I was, I was a little young to start dabbling in assembler, but I remember at school I was fascinated about this mystical other side to computer programming. BASIC was the cosy world for beginners, but I knew there was this other side to programming that involved writing in machine code. In the simple BASIC games I wrote, I often found my games simply too slow on rendering, and wished I could control the game at a faster pace. Often I'd key in game listings from magazines, and these sometimes included portions of machine code - keying in banks of numbers was like magic to me. I was just a bit too young and naive to know where to start looking to learn assembly programming in any detail. However, playing with BASIC on this machine started my life-long interest in programming.

In addition to writing my own programs, most of my time after school and at weekends was sat in my bedreoom playing the cassettes and cartriges that I had. My favourite games were probably 'Radar Rat Race', 'Omega Race', and 'The Perils of Willy'. This is a list of all the games I can remember owning:

| Game                              | Publisher                       | Format       | Comments                  | Url                                                     |
| --------------------------------- | ------------------------------- | ------------ | ------------------------- | ------------------------------------------------------- |
| **Omega Race**                    |                                 |              |                           | https://en.wikipedia.org/wiki/Omega_Race                |
| **The Perils of Willy**           |                                 |              |                           |                                                         |
| **Sargon II Chess**               | Commodore Business Machines Inc | Cartridge    | Chess                     | https://en.wikipedia.org/wiki/Sargon_II_(video_game)    |
| **Bewitched**                     | Imagine Software                | Cassette     | 2-d maze Gauntlet style   |                                                         |
| **Radar Rat Race**                |                                 |              |                           |                                                         |
| **Battlezone**                    |                                 |              |                           |                                                         |
| **Donkey Kong**                   |                                 |              |                           |                                                         |
| **3D Man**                        |                                 |              |                           |                                                         |
| **Krazy Kong**                    | Anirog Software                 | Cassette 16K | Donkey Kong clone         |                                                         |
| **Avenger**                       | Commodore Business Machines Inc | Cartridge    | Space Invaders clone      | https://en.wikipedia.org/wiki/Avenger_(1981_video_game) |
| **Super Lander**                  |                                 |              |                           |                                                         |
| **The Count**                     |                                 |              | Text-based adventure game |                                                         |
| **Voodoo Castle**                 |                                 |              | Text-based adventure game |                                                         |
| **Raid on Fort Knox**             |                                 |              |                           |                                                         |
| **Jumping Jack**                  |                                 |              |                           |                                                         |
| **Crazy Kong**                    |                                 |              | Donkey Kong clone         |                                                         |
| **Frantic**                       | Imagine Software                |              |                           | https://en.wikipedia.org/wiki/Frantic_(video_game)      |
| **Arcadia**                       | Imagine Software                |              | 2-d shooter               |                                                         |
...
The 80's was the real frontier for home computing. A few years after getting my Vic20, I got a Spectrum 128 +2. I remember back in school instead of todays Samsung vs Apple arguments, back then it was Commodore vs Sinclair. Several of my friends had Spectrums, and frankly, being a superior home computer on most fronts, I envied them.

For a while my Vic20 was packed up and put away in the cubboard. I started learning and writing simple BASIC games on the Spectrum, and remember several more years, spending my pocket money on many of the budget Spectrum titles that came out - particularly at the local corner store on my way home from school.

Moving on to today, and I still reminisce about those times. I've known about emulators for a long time (I even remember emulators being a thing back in the day), but with the advancement of Javascript, there have been a few Javascript emulators that have popped up in recent years. Writing emulators in Javascript means that the code is so much more portable and accessible than previous emulators that were mainly written in C or C++.
...
Sites like these have really whetted my appetite to have a go at building my own emulator. The only question is, which one to have a go with. I must admit, I do fondly remember playing many more games on my Spectrum than my Vic20. Games like 'Exolon', 'Zynaps', 'StarQuake', 'Taipan', 'JetPac', 'R-Type', 'Feud', 'Jet Set Willy', 'Dizzy', 'Driller', and 'Daley Thompson's Decathlon' to name but a few. However, after weighing up options, I've decided to have a go writing a Vic20 emulator. The reasons were ultimately, that (a) the Vic20 was my first ever computer, so I do have a certain soft spot for it, and (b) the MOS6502 cpu is simpler that the Zilog Z80A cpu, so my thinking was that the Vic20 emulator should be easier to develop :)
